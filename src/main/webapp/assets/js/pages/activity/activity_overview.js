...
$(function() {    
                ...
                series: [
                    {
                        name: '实时人数',
                        type: 'line',
                        data: [0, 0, 560, 1346, 2154, 2013, 1124],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: '平均人数'
                    ...
                    },
                    {
                        name: '预计人数',
                        type: 'line',
                        data: [0, 0, 400, 1300, 2000, 2100, 900],
                        markLine: {
                            data: [{
                                type: 'average',
                                name: '平均人数'
                    ...
                    series: [
                        {
                            ...
                            data: [4865, 5432, 8754, 12487, 11316]
                        },
                        {
                            name: '消费总额(元)',
                            type: 'bar',
                            ...
                            data: [42574, 56781, 65247, 84226, 81231]
                        }
                    ]
                };
 ...
 // Switchery toggles
        ...
        var tip = d3.tip()
            ...
            .html(function (d) {
                return "<ul class='list-unstyled mb-5'>" +
                    ...
                    "<li>" + "消费金额: &nbsp;" + "<span class='text-semibold pull-right'>" + d.value + "</span>" + "</li>" +
                    "<li>" + "百分比: &nbsp;" + "<span class='text-semibold pull-right'>" + (100 / (sum / d.value)).toFixed(2) + "%" + "</span>" + "</li>" +
                "</ul>";
            })
        ...
        var tip = d3.tip()
            ...
            .html(function (d) {
                return "<ul class='list-unstyled mb-5'>" +
                    ...
                    "<li>" + "总人数: &nbsp;" + "<span class='text-semibold pull-right'>" + d.value + "</span>" + "</li>" +
                    "<li>" + "百分比: &nbsp;" + "<span class='text-semibold pull-right'>" + (100 / (sum / d.value)).toFixed(2) + "%" + "</span>" + "</li>" +
                "</ul>";
            })
        ...
        if(tooltip == "hours") {
            tip.html(function (d, i) {
                return "<div class='text-center'>" +
                        "<h6 class='no-margin'>" + d + "人</h6>" +
                        "<span class='text-size-small'>消费</span>" +
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "#F06292", 0.68, "icon-woman text-pink-400", '女', '64% 平均每小时')
    progressCounter('#goal-progress', 38, 2, "#5C6BC0", 0.82, "icon-man text-indigo-400", '男', '87% 平均每小时')
    ...
    function bulletChart(element, height) {
        ...
        d3.json("assets/demo_data/dashboard/bullets_list.json", function(error, data) {
